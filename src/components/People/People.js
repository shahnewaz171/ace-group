                ...
                <div className="form-group">
                    <div className="view view-insights-page-block view-id-insights_page_block view-display-id-block_1">
                        <div class="view-content">
                            <div class="views-row">
                                <div class="views-field views-field-field-billboard-description">
                                    <div class="field-content">
                                        <div class="billboard" style={{ backgroundColor: '#f5f5f5' }}>
                                ...
                                <div class="views-field views-field-body-1 container">
                                    <div class="field-content offset-md-1 col-md-10 padbot9rem padtop9rem">
